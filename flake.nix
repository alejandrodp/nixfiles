{
  inputs = {
    nixpkgs.url = "github:nixos/nixpkgs/nixos-24.11"; # actualizar esto para actualizar
    ...
    home-manager = {
      url = "github:nix-community/home-manager/release-24.11"; # actualizar esto para actualizar
      inputs.nixpkgs.follows = "nixpkgs";
    };
  };
